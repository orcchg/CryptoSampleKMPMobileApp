 ...
 */
actual data class Money private constructor(
    ...
    actual constructor(): this(
        ...
        currency = Currency.getInstance(Locale.DEFAULT),
        sign = MoneySign.PLUS
    )
    ...
    actual operator fun plus(other: Money): Money {
    ...
    actual operator fun minus(other: Money): Money {
        if (currency.currencyCode != other.currency.currencyCode) {
            throw IllegalArgumentException(EXCEPTION_CURRENCY_EQUAL)
        }
    ...
    actual operator fun div(other: Money): Money {
        if (currency.currencyCode != other.currency.currencyCode) {
            throw IllegalArgumentException(EXCEPTION_CURRENCY_EQUAL)
        }
    ...
    actual operator fun times(other: Money): Money {
        if (currency.currencyCode != other.currency.currencyCode) {
            throw IllegalArgumentException(EXCEPTION_CURRENCY_EQUAL)
        }
    ...
    actual fun isZero(): Boolean = isZero(amount)
...
actual fun Double.money(): Money = this.money(currency = Currency.getInstance(Locale.DEFAULT))
